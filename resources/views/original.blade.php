...
<head>
  ...
  <meta name="csrf-token" content="dudh6vWOG5nSDJH1EbSfZdj3MV8pnAANsZcftsEt">
  <title>Quantus Telematika Indonesia</title>
  <link rel="shortcut icon" href="https://qti.co.id/images/favicon.png" type="image/x-icon">
  <!-- Fonts -->
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;500&amp;display=swap" rel="stylesheet">
  <link rel="stylesheet" href="https://qti.co.id/vendor/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="https://qti.co.id/vendor/fontawesome/css/all.min.css">
...
<body>
  <nav class="navbar fixed-top navbar-expand-lg navbar-light opacity-50 bg-light shadow-sm" id="menu-nav">
    <div class="container">
      <a class="navbar-brand" href="#">
        <img src="https://qti.co.id/images/logo.svg">
      </a>
      <button class="navbar-toggler toggler-custom" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo02">
        <ul class="navbar-nav nav-custom">
          <li class="nav-item">
            <a class="nav-link smooth text-dark" href="#home">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link smooth text-dark" href="#about-us">About Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link smooth text-dark" href="#our-service">Product and Services</a>
          </li>
          <li class="nav-item">
            <a class="nav-link smooth text-dark" href="#our-client">Our Client</a>
          </li>
          <li class="nav-item">
            <a class="nav-link smooth text-dark" href="#our-partner">Technology Partner</a>
          </li>
          <li class="nav-item">
            <a class="nav-link smooth text-dark" href="#contact">Contact Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link smooth text-dark" href="Company_Profil_QTI.pdf" target="_blank" title="Unduh Company Profile"><i class="fa fa-download"></i></a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="overflow-hidden" id="home">
    ...
    <div class="container container-hero d-flex align-items-center">
        ...
        <div class="swiper-container swiper-container-initialized swiper-container-horizontal" id="swiper-with-pagination">
          <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
            <div class="swiper-slide swiper-slide-active" style="width: 930px;">
              <div class="row">
                <div class="col-12 col-sm-6 col-lg-6 col-xl-4 mb-4 mb-lg-0 wow slideInLeft" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: slideInLeft;">
                  <h4>Welcome to</h4>
                  <h1>Quantus <br> Telematika <br> Indonesia</h1>
                  <div class="mt-5">
                    <a href="#about-us" class="btn btn-header btn-sm btn-round smooth">Explore</a>
                  </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-6 col-xl-8 align-self-center wow slideInRight" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: slideInRight;">
                  <img src="https://qti.co.id/images/slider/data1.png" class="img-fluid">
                </div>
              </div>
            </div>
            <div class="swiper-slide swiper-slide-next" style="width: 930px;">
              <div class="row">
                <div class="col-12 col-sm-4">
                  ...
                  <a href="#about-us" class="btn btn-header btn-sm btn-round">Details</a>
                </div>
            ...
            <div class="swiper-slide" style="width: 930px;">
              <div class="row">
                <div class="col-12 col-sm-4">
                  <h4>Indonesian Covid-19 Data Integration</h4>
  ...
  <section class="overflow-hidden" id="about-us">
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-lg-5 text-center wow fadeInLeft" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
          <img src="https://qti.co.id/images/about.png" class="img-fluid">
        </div>
        <div class="col-lg-7">
          <div class="mb-4 wow fadeInRight" data-wow-delay="0.4s" style="visibility: hidden; animation-delay: 0.4s; animation-name: none;">
            <h4 class="text-site text-uppercase font-weight-semibold">About Us</h4>
          ...
          <div class="wow fadeInRight" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
            <h4 class="text-site text-uppercase font-weight-semibold">Our Manifesto</h4>
  ...
  <section class="overflow-hidden" id="our-service">
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-12">
          <div class="text-center wow fadeInUp" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
            <h4 class="text-site text-uppercase font-weight-semibold">PRODUCT AND SERVICES</h4>
            <p>We don't want to push our ideas, we simply want to make what you want.</p>
          </div>
          <div class="content-service">
            <ul class="nav wow fadeInDown" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
              <li>
            ...
            <div class="tab-content">
              <div id="menu1" class="tab-pane fade active show">
                <div class="row">
                  <div class="col-md-7 mb-4 mb-lg-0 wow fadeInLeft" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                  ...
                  <div class="col-md-5 wow fadeInRight" data-wow-delay="0.7s" style="visibility: hidden; animation-delay: 0.7s; animation-name: none;">
              ...
              <div id="menu5" class="tab-pane fade">
                <div class="row">
                  <div class="col-md-6 mb-4 mb-lg-0">
                    ...
                    <!-- <div class="col-md-5">
                                                    <img src="https://qti.co.id/images/simulator/simulator-kapal.png" class="img-fluid" />
                                                </div> -->
                    <ul class="list-unstyled">
                      <li class="media">
                        <img src="https://qti.co.id/images/simulator/simulator-kapal.png" width="120" class="mr-3" alt="...">
                        <div class="media-body">
                          <h5 class="mt-0 mb-1">Vessel Simulator</h5>
                      ...
                      <li class="media my-4">
                        ...
                        <div class="media-body">
                          <h5 class="mt-0 mb-1">Aircraft &amp; Drone Simulator</h5>
                      ...
                      <li class="media">
                        ...
                        <div class="media-body">
                          <h5 class="mt-0 mb-1">Tank Simulator</h5>
                          <p>- APC Simulator<br>
                  ...
                  <div class="col-md-6">
                    ...
                    <ul class="list-unstyled">
                      <li class="media">
                        ...
                        <div class="media-body">
                          <h5 class="mt-0 mb-1">MARS Small Arm Simulator</h5>
                          <!-- <p>All my girls vintage Chanel baby. So you can have your cake. Tonight, tonight, tonight, I'm walking on air. Slowly swallowing down my fear, yeah yeah. Growing fast into a bolt of lightning. So hot and heavy, 'Til dawn. That fairy tale ending with a knight in shining armor. Heavy is the head that wears the crown.</p> -->
                        </div>
                      </li>
                      <li class="media my-4">
                        ...
                        <div class="media-body">
                          <h5 class="mt-0 mb-1">Machine Gun Stability Simulation</h5>
                          <!-- <p>Maybe a reason why all the doors are closed. Cause once you’re mine, once you’re mine. Be your teenage dream tonight. Heavy is the head that wears the crown. It's not even a holiday, nothing to celebrate. A perfect storm, perfect storm.</p> -->
                      ...
                      <li class="media">
                        ...
                        <div class="media-body">
                          <h5 class="mt-0 mb-1">Parachute Simulator</h5>
  ...
  <section class="overflow-hidden" id="our-client">
    <div class="object-client">
      <img src="https://qti.co.id/images/objek-left.png">
    </div>
    <div class="container py-5 my-5">
      <div class="row">
        <div class="col-12 wow fadeInUp" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
          <div class="text-center">
            <h4 class="text-site text-uppercase font-weight-semibold">OUR CLIENT</h4>
          </div>
  ...
  <section class="overflow-hidden" id="our-partner">
    ...
    <div class="container py-5 my-5">
      <div class="row">
        <div class="col-12 wow fadeInUp" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
          <div class="text-center">
            <h4 class="text-site text-uppercase font-weight-semibold">TECHNOLOGY PARTNER</h4>
          </div>
          <div class="row ourclient">
            <div>
              <picture>
  ...
  <section class="overflow-hidden" id="contact">
    <div class="container py-5">
      <div class="row">
        <div class="col-12">
          <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
            <h4 class="text-site text-uppercase font-weight-semibold">CONTACT US</h4>
            <p>Here you can see our contact.</p>
          </div>
          <div class="row">
            <div class="col-lg-5 mb-4 mb-lg-0 wow fadeInLeft" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
              <div class="formcontact">
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleCheck1" placeholder="Your Message..."></textarea>
                  </div>
                  <button type="submit" class="btn btn-primary btn-block">Submit</button>
                </form>
              </div>
            </div>
            <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
              ...
              <div class="footer-address address-contact">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <span><a href="mailto:info@qti.co.id">info@qti.co.id</a></span>
                  </li>
                </ul>
              </div>
            </div>
