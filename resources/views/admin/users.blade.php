                ...
                <div class="overflow-x-auto">
                    <table id="mytable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @if ($users->count() == 0)
                                <tr>
                                    <td colspan="7" class="py-4 text-center">Data users belum ada, silahkan tambahkan
                                        user.</td>
                                </tr>
                            @endif
                            @php
                    ...
                    <div class="p-4">{!! $users->appends(Request::except('page'))->render() !!} </div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div id="updateProductModal{{ $item->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('users.edit', $item->id) }}" method="POST">
                        @csrf
                        <div class="grid gap-4 mb-4 sm:grid-cols-1">
                            <div class="w-full">
                                <label for="name"
