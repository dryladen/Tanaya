                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div
                        ...
                        <button type="button" id="createProductModalButton" data-modal-target="createProductModal"
                            ...
                            class="flex items-center justify-center text-white bg-sky-600 hover:bg-sky-800 focus:ring-4 focus:ring-sky-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                        ...
                        <tbody>
                            ...
                            @foreach ($clients as $item)
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <img class=" w-16 rounded-full" src="{{ asset('client-img/' . $item->image) }}"
                                            alt="user photo">
                                    </td>
